...
<body>
  <nav class="navbar navbar-inverse" style="background-color: #2D6978;color:#FFFFFF">
    ...
    <div class="container-fluid" style="background-color: #2D6978;color:#FFFFFF">
    <table>
        <ul class="nav navbar-nav" style="color:#FFFFFF">
            <li><a style="color:#FFFFFF" href="/Twilio_Project/service/read_service.php">Servicio</a></li>
        </ul>
        </table>
    </div>
